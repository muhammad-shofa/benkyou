      ...
      <table className="min-w-full bg-white">
        <thead>
          <tr>
            ...
            <th className="border border-gray-300 px-4 py-2">Quizzes</th>
            <th className="border border-gray-300 px-4 py-2">Enter Class</th>
                  ...
                  {editSelectedStudents.map((student, index) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() => handleEditRemoveStudent(student._id)}
                      >
                        &times;
                      </button>
                    </li>
                  ...
                  {editSelectedMaterials.map((material, index) => (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        className="text-red-500"
                        onClick={() => handleEditRemoveMaterial(material._id)}
                      >
                        &times;
                      </button>
                    </li>
