        ...
        return (
          <>
            <ul>
              ...
              <li
                onClick={() => navigate("/quizzes-dashboard")}
                className="text-black text-sm flex items-center gap-x-4 cursor-pointer p-2  hover:bg-[#7752FE] hover:text-white duration-200 rounded-md"
              >
                <span className="text-lg">
                  <svg
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="flex items-center justify-center h-20 hover:cursor-pointer"
      >
        ...
        {isSidebarOpen && (
          <>
            <h1 className="text-black font-medium text-xl ml-3">
              {username} <br />
              <hr /> <b className="txet-bold text-sm text-gray-500">{role}</b>
            </h1>
          </>
        )}
      </div>
